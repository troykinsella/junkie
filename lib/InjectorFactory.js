...
var InjectorFactory = {
   ...
   * @param name The name of the injector to create.
   ...
   * @return {Array} Injector type objects.
   */
  injectors: function() {
   ...
   * @param name The name of the injector type.
   * @param Type The injector type (constructor).
   */
...
var injectorDir = path.resolve(__dirname, 'injector');
fs.readdirSync(injectorDir).forEach(function(moduleName) {
  var InjectorType = require('./injector/' + moduleName);
  InjectorFactory.register(InjectorType);
});
