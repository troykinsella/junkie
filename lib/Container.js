 ...
 * <ul>
 *   <li>junkie#newContainer</li>
 *   <li>Container#newChild</li>
 * </ul>
 *
 * @param parent {Container|undefined} The optional parent container.
 * @param resolvers {Array|undefined} The optional list of resolvers.
 *
 * @constructor
 */
...
C._createComponent = function(key, component, descriptor) {
  var comp = new Component(key, component, descriptor, this);
  this._containerResolvers.reverse().forEach(comp.use.bind(comp));
  return comp;
};
 ...
 * @throws ResolutionError When the key cannot be located, or a failure occurs during the resolution process.
 */
